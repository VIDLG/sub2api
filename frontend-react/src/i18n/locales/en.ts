export default {
  ...
  keys: {
    ...
    customKeyPlaceholder: 'Leave empty for auto-generated',
    create: 'Create Key',
  ...
  redeem: {
    ...
    placeholder: 'Paste your redeem code here',
    submit: 'Redeem',
    history: 'Redemption History',
    noHistory: 'No redemption history yet.',
    codeRequired: 'Please enter a redeem code',
  ...
  admin: {
    ...
    usage: {
      ...
      apiKeySearch: 'API key name...',
      accountSearch: 'Account name...',
      // Stats
      totalRequests: 'Total Requests',
      totalTokens: 'Total Tokens',
      totalCost: 'Total Cost',
      ...
      userBilledLabel: 'User Billed',
      accountCostLabel: 'Account Cost',
      // Export
      exportExcel: 'Export Excel',
      exporting: 'Exporting',
      exportingProgress: 'Exporting usage records...',
      exportReady: 'Ready to export {count} records',
      cancelExport: 'Cancel Export',
      ...
      // Column visibility
      columnSettings: 'Column Settings',
      // Cleanup (flat keys for components)
      cleanup: 'Cleanup',
      cleanupTitle: 'Cleanup Usage Records',
      cleanupDescription: 'Submit a cleanup task to delete matching usage records.',
      cleanupWarning:
        'Cleanup is irreversible and will affect historical statistics. Please proceed with caution.',
      cleanupRecentTasks: 'Recent Tasks',
      cleanupNoTasks: 'No cleanup tasks yet',
      cleanupRange: 'Range',
      cleanupDeletedRows: 'Deleted',
      cleanupSubmit: 'Submit Cleanup',
      cleanupSubmitting: 'Submitting...',
      cleanupSubmitSuccess: 'Cleanup task submitted',
      cleanupSubmitFailed: 'Failed to submit cleanup task',
      ...
      cleanupConfirmSubmit: 'Confirm Cleanup',
      cleanupCancelSuccess: 'Cleanup task canceled',
      cleanupCancelFailed: 'Failed to cancel task',
      cleanupMissingRange: 'Please select a date range',
      cleanupCancelConfirmTitle: 'Cancel Task',
      cleanupCancelConfirmMessage: 'Are you sure you want to cancel this cleanup task?',
      cleanupCancelConfirm: 'Confirm Cancel',
      cleanupStatus: {
        pending: 'Pending',
        running: 'Running',
        succeeded: 'Succeeded',
    ...
    aiAnalyzer: {
      ...
      placeholder: 'Ask about usage, errors, costs, or any data question...',
      send: 'Send',
      stop: 'Stop',
      clearChat: 'Clear Chat',
      thinking: 'Thinking...',
      toolCalling: 'Executing...',
      noApiKey: 'Please configure an API key to start chatting',
      apiKeyLabel: 'API Key',
      customKey: 'Custom Key',
      enterCustomKey: 'Enter API Key',
      modelLabel: 'Model',
      ...
      rows: 'rows',
      duration: 'Duration',
      showPanel: 'Show Results',
      hidePanel: 'Hide Results',
      errorPrefix: 'Error',
    ...
    ops: {
      ...
      systemLog: {
        title: 'System Logs',
        description: 'Real-time log stream, sorted by newest first',
        queue: 'Queue',
        written: 'Written',
        dropped: 'Dropped',
        failed: 'Failed',
        lastError: 'Last error:',
        runtimeConfig: 'Runtime Log Config (live)',
        level: 'Level',
        stacktraceLevel: 'Stacktrace',
        samplingInitial: 'Samp. initial',
        samplingThereafter: 'Samp. after',
        retentionDays: 'Retention (d)',
        save: 'Save',
        reset: 'Reset',
        runtimeSaved: 'Log config applied',
        runtimeSaveFailed: 'Failed to save log config',
        runtimeReset: 'Reset to startup config',
        runtimeResetFailed: 'Failed to reset log config',
        runtimeResetConfirm: 'Reset to startup log config immediately?',
        timeRange: 'Time Range',
        component: 'Component',
        platform: 'Platform',
        keyword: 'Keyword',
        ...
        cleanupConfirm: 'Delete logs matching current filters? This cannot be undone.',
        cleanupSuccess: 'Deleted {n} logs',
      ...
      tooltips: {
        ...
        concurrency: 'Real-time account concurrency and availability across platforms.',
