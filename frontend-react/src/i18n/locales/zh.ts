export default {
  ...
  admin: {
    ...
    usage: {
      ...
      exportExcel: '导出 Excel',
      exporting: '导出中',
      exportingProgress: '正在导出使用记录...',
      exportReady: '准备导出 {count} 条记录',
      cancelExport: '取消导出',
      startExport: '开始导出',
      exportSuccess: '导出完成',
      exportFailed: '导出失败',
      estimatedTime: '预计: {time}',
      // Cost tooltip
      rateMultiplier: '倍率',
      ...
      cleanup: '清理',
      cleanupTitle: '清理使用记录',
      cleanupDescription: '提交清理任务以删除匹配的使用记录。',
      cleanupWarning: '清理不可恢复，且会影响历史统计。请谨慎操作。',
      cleanupRecentTasks: '最近任务',
      cleanupNoTasks: '暂无清理任务',
      cleanupRange: '范围',
      cleanupDeletedRows: '已删除',
      cleanupSubmit: '提交清理',
      cleanupSubmitting: '提交中...',
      cleanupSubmitSuccess: '清理任务已提交',
      cleanupSubmitFailed: '提交清理任务失败',
      cleanupConfirmTitle: '确认清理',
      cleanupConfirmMessage: '确定要提交清理任务吗？此操作不可撤销。',
      cleanupConfirmSubmit: '确认清理',
      cleanupCancelSuccess: '清理任务已取消',
      cleanupCancelFailed: '取消任务失败',
      cleanupMissingRange: '请选择时间范围',
      cleanupCancelConfirmTitle: '取消任务',
      cleanupCancelConfirmMessage: '确定要取消该清理任务吗？',
      cleanupCancelConfirm: '确认取消',
      cleanupStatus: {
        pending: '待执行',
        running: '执行中',
        succeeded: '已完成',
    ...
    aiAnalyzer: {
      title: 'AI 分析',
      description: '用自然语言查询和分析平台数据',
      placeholder: '问关于使用量、错误、费用或任何数据的问题...',
      send: '发送',
      stop: '停止',
      clearChat: '清空对话',
      thinking: '思考中...',
      toolCalling: '执行中...',
      noApiKey: '请配置 API Key 后开始对话',
      apiKeyLabel: 'API Key',
      customKey: '自定义 Key',
      enterCustomKey: '输入 API Key',
      modelLabel: '模型',
      selectModel: '选择模型',
      loadingModels: '加载模型中...',
      noModels: '无可用模型',
      ...
      errorPrefix: '错误',
      toolError: '工具执行失败',
      connectionError: '连接失败，请检查 API Key 后重试。',
    },
    ops: {
      title: '运维监控',
      description: '运维监控与排障',
      ...
      settings: {
        ...
        minSeverity: '最低级别',
        alertRecipientsRequired: '已开启预警但未配置接收邮箱，请至少添加一个收件人。',
        minSeverityRequired: '未设置最低预警级别，所有级别的告警均会触发通知。',
        reportConfig: '评估报告配置',
        enableReport: '开启评估报告',
